...
def fetch_url(url, method='GET', headers=None, data=None, timeout=10, cookie_file=None):
    """
    Fetches a URL using urllib.request with retry logic and specific error handling.
    """
    ...
    if cookie_file:
        ...
        # Do NOT install_opener globally as it breaks thread safety
...
class FetchRequest:
    ...
    def set_cookie_file(self, url):
        ...
        # Fallback if cookieStr is still None
